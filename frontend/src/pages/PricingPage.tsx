...
// FIX 1: rimosso useNavigate da react-router-dom (non installato)
// FIX 2: aggiunta prop onNavigate per navigazione interna
// FIX 3: handleCheckoutSuccess usa onNavigate('payment-success')
// FIX 4: aggiunto toggle mensile/annuale con sconto 25%
...
interface PricingPageProps {
  lang: string;
  user: User | null;
  onNavigate: (v: View) => void;       // ← prop corretta
...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    color: "#3B82F6",
    features: [
      "20 Deep Research al giorno",
      "20 Calcola ROI al giorno",
      "Export report DOCX",
      "Storage 2GB",
...
export default function PricingPage({ onNavigate, user }: PricingPageProps) {
  ...
  const handleSelectPlan = (plan: Plan) => {
    if (!isLoggedIn) {
      onNavigate("login");   // ← usa onNavigate, non react-router
      return;
    }
    setSelectedPlan(plan);
  };

  // FIX: handleCheckoutSuccess usa onNavigate, non navigate()
    ...
    >
      ...
      <div style={{ textAlign: "center", marginBottom: "48px" }}>
        ...
        <p style={{ color: "#94a3b8", fontSize: "16px", maxWidth: "520px", margin: "0 auto 32px" }}>
          Analisi immobiliari professionali con AI. Inizia gratis per 14 giorni.
        </p>
